...
const PLACEHOLDER = '/images/career/placeholder.svg'
...
export const careerSteps: CareerStep[] = [
  ...
  },
  {
    ...
    qualification: 'Foundation Dentist, DF1',
    location: 'Newark',
    description:
  ...
  },
  {
    ...
    qualification: 'Dental Core Training, DCT1 · Paediatrics & Restorative',
    location: 'Birmingham',
    description:
  ...
  },
  {
    ...
    qualification: 'Restorative & Aesthetic Dentistry, MSc',
